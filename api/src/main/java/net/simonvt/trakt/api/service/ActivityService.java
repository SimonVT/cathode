...
public interface ActivityService {
    ...
    @GET("/activity/community.json/{apikey}")
    Activity community();

    @GET("/activity/community.json/{apikey}/{types}")
    Activity community(@Path("types") String types);
    ...
    Activity community(@Path("types") String types, @Path("actions") String actions, @Path("startTs") long startTs);

    @GET("/activity/community.json/{apikey}/{types}/{actions}/{startTs}/{endTs}")
    Activity community(@Path("types") String types, @Path("actions") String actions, @Path("startTs") long startTs,
            @Path("endTs") long endTs);

    @GET("/activity/episodes.json/{apikey}/{title}/{seasons}/{episodes}")
    Activity episodes(@Path("title") String title, @Path("seasons") String seasons, @Path("episodes") String episodes);
    ...
    @GET("/activity/friends.json/{apikey}")
    Activity friends();

    @GET("/activity/friends.json/{apikey}/{types}")
    Activity friends(@Path("types") String types);
    ...
    Activity friends(@Path("types") String types, @Path("actions") String actions, @Path("startTs") long startTs);

    @GET("/activity/friends.json/{apikey}/{types}/{actions}/{startTs}/{endTs}")
    Activity friends(@Path("types") String types, @Path("actions") String actions, @Path("startTs") long startTs,
            @Path("endTs") long endTs);

    @GET("/activity/movies.json/{apikey}/{title}")
    Activity movies(@Path("title") String title);
    ...
    Activity movies(@Path("title") String title, @Path("actions") String actions, @Path("startTs") long startTs);
    ...
    Activity seasons(@Path("title") String title, @Path("seasons") String seasons, @Path("actions") String actions);
    ...
    @GET("/activity/shows.json/{apikey}/{title}")
    Activity shows(@Path("title") String title);
    ...
    Activity shows(@Path("title") String title, @Path("actions") String actions, @Path("startTs") long startTs);
    ...
    Activity user(@Path("types") String types, @Path("actions") String actions, @Path("startTs") long startTs);
