...
public interface ShowService {
    ...
    @GET("/show/cancelcheckin/{apikey}")
    TraktResponse cancelCheckin(@Path("apikey") String apiKey) throws RetrofitError;

    @GET("/show/cancelwatching/{apikey}")
    TraktResponse cancelWatching(@Path("apikey") String apiKey) throws RetrofitError;
    ...
    TraktResponse episodeLibrary(@Body ShowEpisodeBody body) throws RetrofitError;

    @POST("/show/episode/seen/{apikey}")
    TraktResponse episodeSeen(@Body ShowEpisodeBody body) throws RetrofitError;

    @GET("/show/episode/summary.json/{apikey}/{tvdbid}/{season}/{episode}")
    TvEntity episodeSummary(@Path("tvdbid") int tvdbId, @Path("season") int season, @Path("episode") int episode)
    ...
    TraktResponse episodeUnseen(@Body ShowEpisodeBody body) throws RetrofitError;
