 ...
 */
package net.simonvt.cathode.common.widget.animation;

import android.graphics.ColorMatrix;
import android.view.animation.DecelerateInterpolator;
import android.view.animation.Interpolator;

import static net.simonvt.cathode.common.widget.animation.ColorMatrices.COLUMN_ALPHA;
import static net.simonvt.cathode.common.widget.animation.ColorMatrices.ROW_ALPHA;
