...
class SyncHiddenWatched @Inject constructor(
  ...
  override fun key(params: Unit): String = "SyncHiddenWatched"

  override fun getCall(params: Unit, page: Int): Call<List<HiddenItem>> =
    usersService.getHiddenItems(HiddenSection.PROGRESS_WATCHED, null, page, 25)
  ...
  override suspend fun handleResponse(
    ...
    val hiddenSeasons = context.contentResolver.query(
      ...
      SeasonColumns.HIDDEN_WATCHED + "=1"
    )
