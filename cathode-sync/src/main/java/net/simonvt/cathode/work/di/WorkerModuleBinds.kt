...
abstract class WorkerModuleBinds {
  ...
  @Binds
  @IntoMap
  @WorkerKey(AuthJobHandlerWorker::class)
  abstract fun authJobHandlerWorker(factory: AuthJobHandlerWorker.Factory): ChildWorkerFactory

  @Binds
  @IntoMap
  @WorkerKey(DataJobHandlerWorker::class)
  abstract fun dataJobHandlerWorker(factory: DataJobHandlerWorker.Factory): ChildWorkerFactory
