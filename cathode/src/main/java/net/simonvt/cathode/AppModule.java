...
import net.simonvt.cathode.provider.helper.DatabaseHelperModule;
...
import net.simonvt.cathode.sync.jobscheduler.JobCreator;
...
import net.simonvt.cathode.sync.scheduler.SchedulerModule;
