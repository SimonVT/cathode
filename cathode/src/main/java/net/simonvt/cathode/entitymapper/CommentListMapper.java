...
public class CommentListMapper implements MappedCursorLiveData.CursorMapper<List<Comment>> {
  ...
  @Override public List<Comment> map(Cursor cursor) {
    ...
    while (cursor.moveToNext()) {
      ...
      final User user =
          new User(null, username, null, name, null, null, null, null, null, null, null,
              userAvatar);
      ...
      comments.add(
          new Comment(id, comment, spoiler, review, -1L, createdAt, replies, likes, userRating,
              user, isUserComment, liked, likedAt));
    }
