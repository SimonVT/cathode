...
public class MovieCastMapper implements MappedCursorLiveData.CursorMapper<List<CastMember>> {
  ...
  @Override public List<CastMember> map(Cursor cursor) {
    ...
    while (cursor.moveToNext()) {
      long personId = Cursors.getLong(cursor, MovieCastColumns.PERSON_ID);
      ...
      String character = Cursors.getString(cursor, MovieCastColumns.CHARACTER);
