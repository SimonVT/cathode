...
public class CollectedHideMovie extends CallJob<HideResponse> {

  private long movieId;

  private boolean hidden;

  public CollectedHideMovie(long movieId, boolean hidden) {
  ...
  @Override public String key() {
    return "CollectedHideMovie?movieId=" + movieId + "&hidden" + hidden;
  }
