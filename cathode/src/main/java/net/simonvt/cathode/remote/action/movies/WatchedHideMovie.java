...
public class WatchedHideMovie extends CallJob<HideResponse> {

  private long movieId;

  private boolean hidden;

  public WatchedHideMovie(long movieId, boolean hidden) {
  ...
  @Override public String key() {
    return "WatchedHideMovie?movieId=" + movieId + "&hidden" + hidden;
  }
