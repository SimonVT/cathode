...
public class WatchedHideShow extends CallJob<HideResponse> {

  private long showId;

  private boolean hidden;

  public WatchedHideShow(long showId, boolean hidden) {
  ...
  @Override public String key() {
    return "WatchedHideShow?showId=" + showId + "&hidden" + hidden;
  }
