...
import net.simonvt.cathode.api.entity.Credits.Credit;
import net.simonvt.cathode.api.entity.Credits.Crew;
...
public class SyncPersonShowCredits extends CallJob<Credits> {
  ...
  @Override public Call<Credits> getCall() {
    return peopleService.shows(traktId, Extended.FULL_IMAGES);
  }
