...
public interface Loaders {
  ...
  int SHOWS_ANTICIPATED = 106;

  int EPISODES_WATCHLIST = 150;
  ...
  int HIDDEN_SHOWS_CALENDAR = 1200;
  int HIDDEN_SHOWS_WATCHED = 1201;
  int HIDDEN_SHOWS_COLLECTED = 1202;
  int HIDDEN_MOVIES_CALENDAR = 1203;
  int HIDDEN_MOVIES_WATCHED = 1204;
  int HIDDEN_MOVIES_COLLECTED = 1205;
}
