...
import net.simonvt.cathode.ui.adapter.MovieSuggestionsPagerAdapter;

public class MovieSuggestionsFragment extends SuggestionsFragment {

  public static final String TAG = "net.simonvt.cathode.ui.fragment.MovieSuggestionsFragment";
