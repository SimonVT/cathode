...
import net.simonvt.cathode.ui.adapter.ShowSuggestionsPagerAdapter;

public class ShowSuggestionsFragment extends SuggestionsFragment {

  public static final String TAG = "net.simonvt.cathode.ui.fragment.ShowSuggestionsFragment";
