...
public abstract class StaggeredGridFragment extends BaseFragment {
  ...
  @InjectView(android.R.id.list) StaggeredGridView gridView;
  ...
  private final StaggeredGridView.OnItemClickListener onClickListener =
      new StaggeredGridView.OnItemClickListener() {
        @Override public void onItemClick(StaggeredGridView parent, View v, int position, long id) {
          StaggeredGridFragment.this.onItemClick(parent, v, position, id);
        }
      };
