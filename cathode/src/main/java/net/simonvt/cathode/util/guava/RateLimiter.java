...
import static net.simonvt.cathode.util.guava.Preconditions.checkArgument;
import static net.simonvt.cathode.util.guava.Preconditions.checkNotNull;
...
public abstract class RateLimiter {
  ...
  static RateLimiter create(SleepingStopwatch stopwatch, double permitsPerSecond) {
    RateLimiter rateLimiter =
        new SmoothRateLimiter.SmoothBursty(stopwatch, 1.0 /* maxBurstSeconds */);
  ...
  static RateLimiter create(SleepingStopwatch stopwatch, double permitsPerSecond, long warmupPeriod,
    ...
    RateLimiter rateLimiter =
        new SmoothRateLimiter.SmoothWarmingUp(stopwatch, warmupPeriod, unit, coldFactor);
    rateLimiter.setRate(permitsPerSecond);
    return rateLimiter;
  }
   ...
   * is
   * configured with. The initial value of this is the same as the {@code permitsPerSecond}
   * argument
