...
public class TraktDatabase extends SQLiteOpenHelper {
  ...
  public interface Tables {
    ...
    String EPISODES_WITH_SHOW_TITLE = EPISODES
        + " JOIN "
        + SHOWS
        + " AS shows ON "
        + SHOWS
        + "."
        + TraktContract.Shows._ID
        + "="
        + EPISODES
        + "."
  ...
  public void onCreate(SQLiteDatabase db) {
    db.execSQL("CREATE TABLE "
        ...
        + " INTEGER DEFAULT 0,"
        + ShowColumns.RATING_VOTES
        + " INTEGER DEFAULT 0,"
        + ShowColumns.RATING_LOVED
        + " INTEGER DEFAULT 0,"
        + ShowColumns.RATING_HATED
        + " INTEGER DEFAULT 0,"
    ...
    db.execSQL("CREATE TABLE "
        + Tables.SHOW_TOP_WATCHERS
        + " ("
        + BaseColumns._ID
        + " INTEGER PRIMARY KEY AUTOINCREMENT,"
        + ShowTopWatchers.SHOW_ID
        + " INTEGER "
        + References.SHOW_ID
        + ","
        + TopWatcherColumns.PLAYS
        + " INTEGER DEFAULT 0,"
        + TopWatcherColumns.USERNAME
        + " TEXT NOT NULL,"
        + TopWatcherColumns.PROTECTED
        + " INTEGER DEFAULT 0,"
        + TopWatcherColumns.FULL_NAME
        + " TEXT,"
        + TopWatcherColumns.GENDER
        + " TEXT,"
        + TopWatcherColumns.AGE
        + " INTEGER,"
        + TopWatcherColumns.LOCATION
        + "TEXT,"
        + TopWatcherColumns.ABOUT
        + " TEXT,"
        + TopWatcherColumns.JOINED
        + " INTEGER DEFAULT 0,"
        + TopWatcherColumns.AVATAR
        + " TEXT,"
        + TopWatcherColumns.URL
        + " TEXT NOT NULL)");

    db.execSQL("CREATE TABLE "
        + Tables.SHOW_TOP_EPISODES
        + " ("
        + BaseColumns._ID
        + " INTEGER PRIMARY KEY AUTOINCREMENT,"
        + TopEpisodeColumns.SHOW_ID
        + " INTEGER "
        + References.SHOW_ID
        + ","
        + TopEpisodeColumns.SEASON_ID
        + " INTEGER "
        + References.SEASON_ID
        + ","
        + TopEpisodeColumns.NUMBER
        + " INTEGER NOT NULL,"
        + TopEpisodeColumns.PLAYS
        + " INTEGER DEFAULT 0,"
        + TopEpisodeColumns.TITLE
        + " TEXT NOT NULL,"
        + TopEpisodeColumns.URL
        + " TEXT,"
        + TopEpisodeColumns.FIRST_AIRED
        + " INTEGER DEFAULT 0)");
    ...
    db.execSQL("CREATE TABLE "
        ...
        + ImageColumns.BANNER
        + " TEXT,"
        + EpisodeColumns.RATING_PERCENTAGE
        + " INTEGER DEFAULT 0,"
        + EpisodeColumns.RATING_VOTES
        + " INTEGER DEFAULT 0,"
        + EpisodeColumns.RATING_LOVED
        + " INTEGER DEFAULT 0,"
        + EpisodeColumns.RATING_HATED
        + " INTEGER DEFAULT 0,"
    ...
    db.execSQL("CREATE TABLE "
        ...
        + " INTEGER,"
        + MovieColumns.RATING_VOTES
        + " INTEGER DEFAULT 0,"
        + MovieColumns.RATING_LOVED
        + " INTEGER DEFAULT 0,"
        + MovieColumns.RATING_HATED
        + " INTEGER DEFAULT 0,"
        + MovieColumns.RATING
        + " INTEGER DEFAULT 0,"
        + MovieColumns.WATCHERS
        + " INTEGER DEFAULT 0,"
        + MovieColumns.PLAYS
        + " INTEGER DEFAULT 0,"
        + MovieColumns.SCROBBLES
        + " INTEGER DEFAULT 0,"
        + MovieColumns.CHECKINS
        + " INTEGER DEFAULT 0,"
    ...
    db.execSQL("CREATE TABLE "
        + Tables.MOVIE_TOP_WATCHERS
        + " ("
        + BaseColumns._ID
        + " INTEGER PRIMARY KEY AUTOINCREMENT,"
        + MovieTopWatchers.MOVIE_ID
        + " INTEGER "
        + References.MOVIE_ID
        + ","
        + TopWatcherColumns.PLAYS
    ...
    db.execSQL("CREATE TABLE "
        ...
        + BaseColumns._ID
        + " INTEGER PRIMARY KEY AUTOINCREMENT,"
        + MovieDirectors.MOVIE_ID
        + " INTEGER "
        + References.MOVIE_ID
        + ","
        + MovieDirectors.NAME
        + " TEXT NOT NULL,"
        + MovieDirectors.HEADSHOT
        + " TEXT)");

    db.execSQL("CREATE TABLE "
        + Tables.MOVIE_WRITERS
        + " ("
        + BaseColumns._ID
        + " INTEGER PRIMARY KEY AUTOINCREMENT,"
        + MovieWriters.MOVIE_ID
        + " INTEGER "
        + References.MOVIE_ID
        + ","
        + MovieWriters.NAME
        ...
        + MovieWriters.JOB
        + " TEXT,"
        + MovieWriters.HEADSHOT
        + " TEXT)");

    db.execSQL("CREATE TABLE "
        + Tables.MOVIE_PRODUCERS
        + " ("
        + BaseColumns._ID
        + " INTEGER PRIMARY KEY AUTOINCREMENT,"
        + MovieProducers.MOVIE_ID
        + " INTEGER "
        + References.MOVIE_ID
        + ","
        + MovieProducers.NAME
        + " TEXT NOT NULL,"
        + MovieProducers.EXECUTIVE
        + " INTEGER NOT NULL,"
