...
public class TraktProvider extends ContentProvider {
  ...
  static {
    ...
    URI_MATCHER.addURI(AUTHORITY, TraktContract.PATH_SHOWS + "/" + TraktContract.PATH_WITHID + "/*",
        SHOWS_ID);
    URI_MATCHER.addURI(AUTHORITY, TraktContract.PATH_SHOWS + "/" + TraktContract.PATH_WITHNEXT,
        SHOWS_WITHNEXT);
    URI_MATCHER.addURI(AUTHORITY, TraktContract.PATH_SHOWS
        + "/"
        + TraktContract.PATH_WITHNEXT
        + "/"
        + TraktContract.PATH_IGNOREWATCHED, SHOWS_WITHNEXT_IGNOREWATCHED);
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_TOPWATCHERS + "/" + TraktContract.PATH_FROMSHOW + "/*",
        SHOW_TOP_WATCHERS);
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_TOPEPISODES + "/" + TraktContract.PATH_FROMSHOW + "/*",
        SHOW_TOP_EPISODES);
    URI_MATCHER.addURI(AUTHORITY,
    ...
    URI_MATCHER.addURI(AUTHORITY, TraktContract.PATH_SHOWS + "/" + TraktContract.PATH_WATCHLIST,
        SHOWS_WATCHLIST);
    URI_MATCHER.addURI(AUTHORITY, TraktContract.PATH_SHOWS + "/" + TraktContract.PATH_COLLECTION,
        SHOWS_COLLECTION);
    URI_MATCHER.addURI(AUTHORITY, TraktContract.PATH_SHOWS + "/" + TraktContract.PATH_WATCHED,
        SHOWS_WATCHED);

    URI_MATCHER.addURI(AUTHORITY, TraktContract.PATH_SEASONS, SEASONS);
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_SEASONS + "/" + TraktContract.PATH_WITHID + "/*", SEASON_ID);
    URI_MATCHER.addURI(AUTHORITY,
    ...
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_EPISODES + "/" + TraktContract.PATH_WITHID + "/*", EPISODE_ID);
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_EPISODES + "/" + TraktContract.PATH_FROMSHOW + "/*", EPISODES_FROMSHOW);
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_EPISODES + "/" + TraktContract.PATH_FROMSEASON + "/*",
        EPISODES_FROMSEASON);
    URI_MATCHER.addURI(AUTHORITY, TraktContract.PATH_EPISODES + "/" + TraktContract.PATH_WATCHLIST,
        EPISODES_WATCHLIST);
    ...
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_GENRES + "/" + TraktContract.PATH_FROMMOVIE + "/*", MOVIE_GENRES);
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_TOPWATCHERS + "/" + TraktContract.PATH_MOVIES + "/*",
        MOVIE_TOP_WATCHERS);
    URI_MATCHER.addURI(AUTHORITY,
        TraktContract.PATH_ACTORS + "/" + TraktContract.PATH_FROMMOVIE + "/*", MOVIE_ACTORS);
    URI_MATCHER.addURI(AUTHORITY,
  ...
  public boolean onCreate() {
    database = new TraktDatabase(getContext());
    return true;
  }
  ...
  private Uri getBaseUri(Uri uri) {
    return TraktContract.BASE_CONTENT_URI
        .buildUpon()
