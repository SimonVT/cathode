...
public class CalendarSyncAdapter extends AbstractThreadedSyncAdapter {
  ...
  public void onPerformSync(Account account, Bundle extras, String authority,
    ...
    Cursor episodes =
        context.getContentResolver().query(TraktContract.Episodes.CONTENT_URI, new String[] {
            TraktContract.Episodes._ID, TraktContract.Episodes.SHOW_ID,
            TraktContract.Episodes.TITLE, TraktContract.Episodes.SEASON,
            TraktContract.Episodes.EPISODE, TraktContract.Episodes.FIRST_AIRED,
    ...
    while (episodes.moveToNext()) {
      ...
      final String title =
          episodes.getString(episodes.getColumnIndex(TraktContract.Episodes.TITLE));
      ...
      final long firstAired =
          episodes.getLong(episodes.getColumnIndex(TraktContract.Episodes.FIRST_AIRED));

      Cursor show = context.getContentResolver()
          .query(TraktContract.Shows.buildShowUri(showId), new String[] {
              TraktContract.Shows.TITLE, TraktContract.Shows.RUNTIME,
          }, null, null, null);
      show.moveToFirst();
