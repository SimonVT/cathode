...
public class SeasonsAdapter extends CursorAdapter {
  ...
  private void bindWatched(Context context, ViewHolder vh, Cursor cursor) {
    final int airdateCount =
        cursor.getInt(cursor.getColumnIndexOrThrow(TraktContract.Seasons.AIRDATE_COUNT));
    final int unairedCount =
        cursor.getInt(cursor.getColumnIndexOrThrow(TraktContract.Seasons.UNAIRED_COUNT));
    final int watchedCount =
        cursor.getInt(cursor.getColumnIndexOrThrow(TraktContract.Seasons.WATCHED_COUNT));
  ...
  public void bindView(View view, Context context, Cursor cursor) {
    ...
    final int seasonNumber =
        cursor.getInt(cursor.getColumnIndexOrThrow(TraktContract.Seasons.SEASON));
    final int airdateCount =
        cursor.getInt(cursor.getColumnIndexOrThrow(TraktContract.Seasons.AIRDATE_COUNT));
    final int unairedCount =
        cursor.getInt(cursor.getColumnIndexOrThrow(TraktContract.Seasons.UNAIRED_COUNT));
